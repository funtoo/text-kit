...
EGO_SUM=(
	...
	"github.com/!puerkito!bio/goquery v1.6.0"
	"github.com/!puerkito!bio/goquery v1.6.0/go.mod"
...
SRC_URI="https://api.github.com/repos/dnote/dnote/tarball/cli-v0.12.0 -> dnote-0.12.0.tar.gz
         ${EGO_SUM_SRC_URI}"
