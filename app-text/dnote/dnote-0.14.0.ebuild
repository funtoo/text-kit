...
EGO_SUM=(
	...
	"github.com/go-gorp/gorp/v3 v3.0.5/go.mod"
	...
	"github.com/gorilla/csrf v1.7.1/go.mod"
	...
	"github.com/nelsam/hel/v2 v2.3.2/go.mod"
	...
	"github.com/poy/onpar v0.0.0-20200406201722-06f95a1c68e8/go.mod"
	...
	"github.com/rubenv/sql-migrate v1.3.1/go.mod"
...
SRC_URI="https://api.github.com/repos/dnote/dnote/tarball/cli-v0.14.0 -> dnote-0.14.0.tar.gz
         ${EGO_SUM_SRC_URI}"
